    ...
    <div class="content-header p-4 pb-2">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('student-records.index')}}">{{__('main.year_semester_register')}}</a></li>
                        <li class="breadcrumb-item"><a href="{{route('student-records.create',$student->id)}}">{{__('main.student_qualification_create')}}</a></li>
                    </ol>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <h1 class="m-0"> </h1>
