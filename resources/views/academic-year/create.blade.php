                        ...
                        @csrf
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="BaslamaTarihi" type="date" class="form-control @error('BaslamaTarihi') is-invalid @enderror" name="BaslamaTarihi" value="{{ old('BaslamaTarihi') }}" required autocomplete="BaslamaTarihi" autofocus>
